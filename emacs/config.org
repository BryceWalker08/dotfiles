...
#+END_SRC
* Haskell and Making Emacs for Coding
This section adds the basic haskell package as well as LSP features, autocomplete, and linting inside of Emacs to make coding easier.
#+BEGIN_SRC emacs-lisp
